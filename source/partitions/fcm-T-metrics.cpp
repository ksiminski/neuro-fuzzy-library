...
template<>
ksi::dataset ksi::fcm_T_metrics<double>::elaborate_gaussian_prototypes (
...
template<>
ksi::dataset ksi::fcm_T_metrics<ksi::ext_fuzzy_number_gaussian>::elaborate_gaussian_prototypes (
   const int _nClusters, 
   const int nAttr, 
...
template <> 
ksi::partition ksi::fcm_T_metrics<double>::elaborate_gaussian_partition (
   const int _nClusters, 
   const int nAttr, 
   const std::vector<std::vector<double>> & mV, 
   const std::vector<std::vector<double>> & mS)
