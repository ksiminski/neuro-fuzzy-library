...
namespace ksi
{
   ...
   public:
     ...
     public:
      ...
      std::vector<std::tuple<std::vector<double>, std::size_t, size_t>> get_answers_for_test_classification_depth(bool useTestDataset = true) const;
...
namespace ksi
{
     ...
     * 
     * @author Generated based on three_way_decision_nfs
     * @date 2026-01-24
     */
