...
namespace ksi
{
    ...
    */
   class fcom_tsk : virtual public abstract_tsk, virtual public abstract_fcom
   {
   ...
   public:
       ...
       * @date  2019-12-20
       */
      fcom_tsk (int nRules, double dbFrobeniusEpsilon, int nTuningIterations,
      ...
      fcom_tsk(const fcom_tsk & a);
      fcom_tsk(fcom_tsk && a);
      fcom_tsk & operator = (const fcom_tsk & a);
      fcom_tsk & operator = (fcom_tsk && a);
      ~fcom_tsk();
